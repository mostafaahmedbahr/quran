...
//
//     final adanModel = adanModelFromJson(jsonString);

import 'dart:convert';

AdanModel adanModelFromJson(String str) => AdanModel.fromJson(json.decode(str));

String adanModelToJson(AdanModel data) => json.encode(data.toJson());
...
class AdanModel {
  ...
  factory AdanModel.fromJson(Map<String, dynamic> json) => AdanModel(
    code: json["code"],
    status: json["status"],
